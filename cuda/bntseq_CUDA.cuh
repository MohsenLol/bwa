...
__forceinline__ __device__ bns_pos2rid_gpu(const bntseq_t *bns, int64_t pos_f);
__forceinline__ __device__ static  bns_intv2rid_gpu(const bntseq_t *bns, int64_t rb, int64_t re);
